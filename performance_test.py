...
def run_all_tests():
    for loss in (0, 1, 5):
        performance_test('./quic_perf_server','./quic_perf_client -d=10 192.168.0.1', bw=5,loss=loss)
    for loss in (0, 1, 5):
        performance_test('./tcp_perf_server','./tcp_perf_client -d=10 192.168.0.1', bw=5,loss=loss)
